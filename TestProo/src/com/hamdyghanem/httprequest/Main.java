...
public class Main extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		try {
			...
			//lbl = (TextView) findViewById(R.id.);
			//
	...
	public void clickbutton(View v) {
		try {
			...
			//String url = "http://166.104.112.17:8080/webservice1.php?user=1&format=json";
			String url = "http://166.104.112.17/webservice1.php?user=1&format=json";
...
//					map.put("FullName", jObject.getString("FullName"));
			//		map.put("idusers", jObject.getString("idusers"));
					map.put("mem_email", jObject.getString("UserName"));
					map.put("passwd", jObject.getString("FullName"));
